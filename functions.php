...
function read_video_metadata( $file ) {
    ...
    $metadata['durationFinal'] = getDuration($file);
        ...
        $methods = [
            ...
            'jazzcash' => [
                ...
                'form_fields' => [
                    'physical_address' => [
                        'type' => 'textarea',
                        'label' => 'Your jazzcash mobile number',
                        'desc' => 'We will send you payment to this address directly.',
                    ],
                ],
            ],
            ...
            'easypaisa' => [
                ...
                'form_fields' => [
                    'physical_address' => [
                        'type' => 'textarea',
                        'label' => 'Your easypaisa mobile number',
                        'desc' => 'We will send you payment to this address directly.',
                    ],
                ],
            ],
            ...
            'payoneer' => [
                ...
                'form_fields' => [
                    'physical_address' => [
                        'type' => 'textarea',
                        'label' => 'Your payoneer account email address',
                        'desc' => 'We will send you payment to this address directly.',
                    ],
                ],
            ],
